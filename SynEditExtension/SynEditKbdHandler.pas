...
type
  ...
  TMouseCursorEvent =  procedure(Sender: TObject; const aLineCharPos: TPoint; var aCursor: TCursor) of object;
  ...
  TSynEditKbdHandler = class (TObject)
    ...
    public
      ...
      procedure ExecuteMouseCursor(Sender: TObject; const aLineCharPos: TPoint; var aCursor: TCursor);
...
procedure TSynEditKbdHandler.ExecuteMouseCursor(Sender: TObject; const aLineCharPos: TPoint; var aCursor: TCursor);
var
  cHandler: Integer;
begin
